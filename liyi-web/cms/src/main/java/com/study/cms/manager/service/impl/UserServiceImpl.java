...
import com.study.cms.manager.dao.impl.hibernate.UserDaoHibernateImpl;
import com.study.cms.manager.dao.impl.jdbc.UserDaoImpl;
import com.study.cms.manager.dao.impl.mybatis.UserDaoMyBatisImpl;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public PageRes queryUsersPage(String username,String name,Integer sex,Integer curPage,Integer pageSize){
        //1.根据参数查询数据库记录的总数
        ...
        // 当前展示的是第几页
        // 当前页的真实数据
        List<User> list = userDao.queryUsers(username, name, sex,curPage,pageSize);
